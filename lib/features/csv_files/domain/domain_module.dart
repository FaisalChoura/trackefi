...
import 'package:Trackefi/features/csv_files/domain/usecase/get_first_two_lines_of_file_usecase.dart';
...
final getFirstTwoLinesOfFileUseCase = Provider<GetFirstTwoLinesOfFileUseCase>(
  (ref) => GetFirstTwoLinesOfFileUseCase(),
);
